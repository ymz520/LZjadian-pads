...
//- (void)viewDidLoad {
//    [super viewDidLoad];
//    UICollectionView *collectionV=[[UICollectionView alloc]initWithFrame:CGRectMake(20, 30, self.view.frame.size.width, 200) collectionViewLayout:[[handelelayout alloc]init]];
